...
* WSL 1 / This is **not safe** to use this library due to [lack of resource management](https://github.com/microsoft/WSL/issues/4509)
* Windows: Due to some issues, Windows is currently not supported.
